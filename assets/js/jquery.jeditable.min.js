										...
										if ($.isFunction(settings.target)) {
											...
											var ajaxoptions = {
												...
												success: function (result, status) {
													...
													result = intercept.apply(self, [result, status]), "html" === ajaxoptions.dataType && $(self).html(result_value), console.log("result_url test: " + result_url), $(self).parent('a').attr("href", result_url), self.editing = !1, callback.apply(self, [result, settings, submitdata]), $.trim($(self).html()) || $(self).html(settings.placeholder)
												},
